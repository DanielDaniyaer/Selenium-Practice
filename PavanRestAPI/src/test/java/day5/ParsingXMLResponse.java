...
/*	
		...
		.then()
			...
			.body("TravelerinformationResponse.totalrecord",equalTo("46048"))
...
*/		
	...
	void testXMLResponseBody() {
		...
		//verify traveler name is in response
		...
		for(String travelername:traveler_names) {
			if(travelername.contentEquals("da")) {
				status=true;
				break;
			}
		}
